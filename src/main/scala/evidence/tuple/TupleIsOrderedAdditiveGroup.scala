...
/**
  ...
  * under componentwise negation and addition and lexicographic ordering,
  * provided all element types have [[OrderedAdditiveGroup]] instances.
  */
trait TupleIsOrderedAdditiveGroup:

  given [X : OrderedAdditiveGroup as X]: OrderedAdditiveGroup[X *: EmptyTuple]
  with
  ...
  given [
    X : OrderedAdditiveGroup as X,
    Y : OrderedAdditiveGroup as Y,
  ]: OrderedAdditiveGroup[(X, Y)] with
  ...
  given [
    X : OrderedAdditiveGroup as X,
    Y : OrderedAdditiveGroup as Y,
    Z : OrderedAdditiveGroup as Z,
  ]: OrderedAdditiveGroup[(X, Y, Z)] with
  ...
  given [
    X1 : OrderedAdditiveGroup as X1,
    X2 : OrderedAdditiveGroup as X2,
    X3 : OrderedAdditiveGroup as X3,
    X4 : OrderedAdditiveGroup as X4,
  ]: OrderedAdditiveGroup[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : OrderedAdditiveGroup as X3,
    X4 : OrderedAdditiveGroup as X4,
    X5 : OrderedAdditiveGroup as X5,
  ]: OrderedAdditiveGroup[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : OrderedAdditiveGroup as X4,
    X5 : OrderedAdditiveGroup as X5,
    X6 : OrderedAdditiveGroup as X6,
  ]: OrderedAdditiveGroup[(X1, X2, X3, X4, X5, X6)] with
