...
/**
  ...
  * [[OrderedDifferenceSemiring]] under componentwise addition, subtraction, and
  * multiplication and lexicographic ordering, provided all element types have
  * [[OrderedDifferenceSemiring]] instances.
  */
trait TupleIsOrderedDifferenceSemiring:

  given [X : OrderedDifferenceSemiring as X]
    : OrderedDifferenceSemiring[X *: EmptyTuple] with
  ...
  given [
    X : OrderedDifferenceSemiring as X,
    Y : OrderedDifferenceSemiring as Y,
  ]: OrderedDifferenceSemiring[(X, Y)] with
  ...
  given [
    X : OrderedDifferenceSemiring as X,
    Y : OrderedDifferenceSemiring as Y,
    Z : OrderedDifferenceSemiring as Z,
  ]: OrderedDifferenceSemiring[(X, Y, Z)] with
  ...
  given [
    X1 : OrderedDifferenceSemiring as X1,
    X2 : OrderedDifferenceSemiring as X2,
    X3 : OrderedDifferenceSemiring as X3,
    X4 : OrderedDifferenceSemiring as X4,
  ]: OrderedDifferenceSemiring[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : OrderedDifferenceSemiring as X3,
    X4 : OrderedDifferenceSemiring as X4,
    X5 : OrderedDifferenceSemiring as X5,
  ]: OrderedDifferenceSemiring[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : OrderedDifferenceSemiring as X4,
    X5 : OrderedDifferenceSemiring as X5,
    X6 : OrderedDifferenceSemiring as X6,
  ]: OrderedDifferenceSemiring[(X1, X2, X3, X4, X5, X6)] with
