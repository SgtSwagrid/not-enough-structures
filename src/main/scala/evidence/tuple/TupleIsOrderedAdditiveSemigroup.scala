...
/**
  ...
  * [[OrderedAdditiveSemigroup]] under componentwise addition and lexicographic
  * ordering, provided all element types have [[OrderedAdditiveSemigroup]]
  * instances.
  */
trait TupleIsOrderedAdditiveSemigroup:

  given [X : OrderedAdditiveSemigroup as X]
    : OrderedAdditiveSemigroup[X *: EmptyTuple] with
  ...
  given [
    X : OrderedAdditiveSemigroup as X,
    Y : OrderedAdditiveSemigroup as Y,
  ]: OrderedAdditiveSemigroup[(X, Y)] with
  ...
  given [
    X : OrderedAdditiveSemigroup as X,
    Y : OrderedAdditiveSemigroup as Y,
    Z : OrderedAdditiveSemigroup as Z,
  ]: OrderedAdditiveSemigroup[(X, Y, Z)] with
  ...
  given [
    X1 : OrderedAdditiveSemigroup as X1,
    X2 : OrderedAdditiveSemigroup as X2,
    X3 : OrderedAdditiveSemigroup as X3,
    X4 : OrderedAdditiveSemigroup as X4,
  ]: OrderedAdditiveSemigroup[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : OrderedAdditiveSemigroup as X3,
    X4 : OrderedAdditiveSemigroup as X4,
    X5 : OrderedAdditiveSemigroup as X5,
  ]: OrderedAdditiveSemigroup[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : OrderedAdditiveSemigroup as X4,
    X5 : OrderedAdditiveSemigroup as X5,
    X6 : OrderedAdditiveSemigroup as X6,
  ]: OrderedAdditiveSemigroup[(X1, X2, X3, X4, X5, X6)] with
