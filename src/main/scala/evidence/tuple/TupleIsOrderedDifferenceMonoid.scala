...
/**
  ...
  * [[OrderedDifferenceMonoid]] under componentwise addition and subtraction and
  * lexicographic ordering, provided all element types have
  * [[OrderedDifferenceMonoid]] instances.
  */
trait TupleIsOrderedDifferenceMonoid:

  given [X : OrderedDifferenceMonoid as X]
    : OrderedDifferenceMonoid[X *: EmptyTuple] with
  ...
  given [
    X : OrderedDifferenceMonoid as X,
    Y : OrderedDifferenceMonoid as Y,
  ]: OrderedDifferenceMonoid[(X, Y)] with
  ...
  given [
    X : OrderedDifferenceMonoid as X,
    Y : OrderedDifferenceMonoid as Y,
    Z : OrderedDifferenceMonoid as Z,
  ]: OrderedDifferenceMonoid[(X, Y, Z)] with
  ...
  given [
    X1 : OrderedDifferenceMonoid as X1,
    X2 : OrderedDifferenceMonoid as X2,
    X3 : OrderedDifferenceMonoid as X3,
    X4 : OrderedDifferenceMonoid as X4,
  ]: OrderedDifferenceMonoid[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : OrderedDifferenceMonoid as X3,
    X4 : OrderedDifferenceMonoid as X4,
    X5 : OrderedDifferenceMonoid as X5,
  ]: OrderedDifferenceMonoid[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : OrderedDifferenceMonoid as X4,
    X5 : OrderedDifferenceMonoid as X5,
    X6 : OrderedDifferenceMonoid as X6,
  ]: OrderedDifferenceMonoid[(X1, X2, X3, X4, X5, X6)] with
