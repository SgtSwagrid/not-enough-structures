...
/**
  * Evidence that tuples of any arity up to 6 form an [[EuclideanRing]] under
  * componentwise addition, negation, multiplication, and division, provided all
  * element types have [[EuclideanRing]] instances.
  */
trait TupleIsEuclideanRing:

  given [X : EuclideanRing as X]: EuclideanRing[X *: EmptyTuple] with
  ...
  given [X : EuclideanRing as X, Y : EuclideanRing as Y]: EuclideanRing[(X, Y)]
  with
  ...
  given [
    X : EuclideanRing as X,
    Y : EuclideanRing as Y,
    Z : EuclideanRing as Z,
  ]: EuclideanRing[(X, Y, Z)] with
  ...
  given [
    X1 : EuclideanRing as X1,
    X2 : EuclideanRing as X2,
    X3 : EuclideanRing as X3,
    X4 : EuclideanRing as X4,
  ]: EuclideanRing[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : EuclideanRing as X3,
    X4 : EuclideanRing as X4,
    X5 : EuclideanRing as X5,
  ]: EuclideanRing[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : EuclideanRing as X4,
    X5 : EuclideanRing as X5,
    X6 : EuclideanRing as X6,
  ]: EuclideanRing[(X1, X2, X3, X4, X5, X6)] with
