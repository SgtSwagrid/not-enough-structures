...
/**
  * Evidence that tuples of any arity up to 6 form an [[OrderedSemiring]] under
  * componentwise addition and multiplication and lexicographic ordering,
  * provided all element types have [[OrderedSemiring]] instances.
  */
trait TupleIsOrderedSemiring:

  given [X : OrderedSemiring as X]: OrderedSemiring[X *: EmptyTuple] with
  ...
  given [
    X : OrderedSemiring as X,
    Y : OrderedSemiring as Y,
  ]: OrderedSemiring[(X, Y)] with
  ...
  given [
    X : OrderedSemiring as X,
    Y : OrderedSemiring as Y,
    Z : OrderedSemiring as Z,
  ]: OrderedSemiring[(X, Y, Z)] with
  ...
  given [
    X1 : OrderedSemiring as X1,
    X2 : OrderedSemiring as X2,
    X3 : OrderedSemiring as X3,
    X4 : OrderedSemiring as X4,
  ]: OrderedSemiring[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : OrderedSemiring as X3,
    X4 : OrderedSemiring as X4,
    X5 : OrderedSemiring as X5,
  ]: OrderedSemiring[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : OrderedSemiring as X4,
    X5 : OrderedSemiring as X5,
    X6 : OrderedSemiring as X6,
  ]: OrderedSemiring[(X1, X2, X3, X4, X5, X6)] with
