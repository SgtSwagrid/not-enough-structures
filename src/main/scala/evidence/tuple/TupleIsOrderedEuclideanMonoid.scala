...
/**
  * Evidence that tuples of any arity up to 6 form an [[OrderedEuclideanMonoid]]
  * under componentwise multiplication and division and lexicographic ordering,
  * provided all element types have [[OrderedEuclideanMonoid]] instances.
  */
trait TupleIsOrderedEuclideanMonoid:

  given [X : OrderedEuclideanMonoid as X]
    : OrderedEuclideanMonoid[X *: EmptyTuple] with
  ...
  given [
    X : OrderedEuclideanMonoid as X,
    Y : OrderedEuclideanMonoid as Y,
  ]: OrderedEuclideanMonoid[(X, Y)] with
  ...
  given [
    X : OrderedEuclideanMonoid as X,
    Y : OrderedEuclideanMonoid as Y,
    Z : OrderedEuclideanMonoid as Z,
  ]: OrderedEuclideanMonoid[(X, Y, Z)] with
  ...
  given [
    X1 : OrderedEuclideanMonoid as X1,
    X2 : OrderedEuclideanMonoid as X2,
    X3 : OrderedEuclideanMonoid as X3,
    X4 : OrderedEuclideanMonoid as X4,
  ]: OrderedEuclideanMonoid[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : OrderedEuclideanMonoid as X3,
    X4 : OrderedEuclideanMonoid as X4,
    X5 : OrderedEuclideanMonoid as X5,
  ]: OrderedEuclideanMonoid[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : OrderedEuclideanMonoid as X4,
    X5 : OrderedEuclideanMonoid as X5,
    X6 : OrderedEuclideanMonoid as X6,
  ]: OrderedEuclideanMonoid[(X1, X2, X3, X4, X5, X6)] with
