...
/**
  ...
  * [[OrderedMultiplicativeSemigroup]] under componentwise multiplication and
  * lexicographic ordering, provided all element types have
  * [[OrderedMultiplicativeSemigroup]] instances.
  */
trait TupleIsOrderedMultiplicativeSemigroup:

  given [X : OrderedMultiplicativeSemigroup as X]
    : OrderedMultiplicativeSemigroup[X *: EmptyTuple] with
  ...
  given [
    X : OrderedMultiplicativeSemigroup as X,
    Y : OrderedMultiplicativeSemigroup as Y,
  ]: OrderedMultiplicativeSemigroup[(X, Y)] with
  ...
  given [
    X : OrderedMultiplicativeSemigroup as X,
    Y : OrderedMultiplicativeSemigroup as Y,
    Z : OrderedMultiplicativeSemigroup as Z,
  ]: OrderedMultiplicativeSemigroup[(X, Y, Z)] with
  ...
  given [
    X1 : OrderedMultiplicativeSemigroup as X1,
    X2 : OrderedMultiplicativeSemigroup as X2,
    X3 : OrderedMultiplicativeSemigroup as X3,
    X4 : OrderedMultiplicativeSemigroup as X4,
  ]: OrderedMultiplicativeSemigroup[(X1, X2, X3, X4)] with
  ...
  given [
    ...
    X3 : OrderedMultiplicativeSemigroup as X3,
    X4 : OrderedMultiplicativeSemigroup as X4,
    X5 : OrderedMultiplicativeSemigroup as X5,
  ]: OrderedMultiplicativeSemigroup[(X1, X2, X3, X4, X5)] with
  ...
  given [
    ...
    X4 : OrderedMultiplicativeSemigroup as X4,
    X5 : OrderedMultiplicativeSemigroup as X5,
    X6 : OrderedMultiplicativeSemigroup as X6,
  ]: OrderedMultiplicativeSemigroup[(X1, X2, X3, X4, X5, X6)] with
